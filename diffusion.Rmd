...
# Extra high initial Concentration:
res=diff1(initialC=100,nx=10,dx=1,nt=10,dt=30,D=0.006,area=1)
...
# many time steps:
res=diff1(initialC=10,nx=10,dx=1,nt=100,dt=30,D=0.006,area=1)
...
# Extra high diffusivity
res=diff1(initialC=10,nx=10,dx=1,nt=10,dt=30,D=0.06,area=1)

filled.contour(res$conc, xlab="Time", ylab="Distance")
ggsave("high_diff.jpg")
```
